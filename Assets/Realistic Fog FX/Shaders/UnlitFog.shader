	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( _FogGlow + _FogColor ) * ( tex2DNode3 * IN.ase_color ) ).rgb;
...
/*ASEBEGIN
Version=18909
338;392;1536;928;1428.755;406.7216;1.5424;True;False
...
WireConnection;83;2;64;0
WireConnection;83;3;78;0
ASEEND*/
//CHKSM=B703B9EA56EBD9F7F7CFCA201D8CF2D365333CB1